...
|   class    |   pixs   | num  | frequent |
| :--------: | :------: | :--: | :------: |
| background |    0     |  0   |  0.00%   |
|    SAS     | 28806836 | 740  |  20.91%  |
|    LHB     |  923976  | 194  |  5.48%   |
|     D      | 53574251 | 739  |  20.88%  |
|     HH     | 35137316 | 732  |  20.68%  |
|    SUB     | 4911119  | 159  |  4.49%   |
|    SUP     | 5293877  | 179  |  5.06%   |
|     GL     |  821770  | 205  |  5.79%   |
|     GC     | 4194811  | 207  |  5.85%   |
|    SCB     |  700838  | 178  |  5.03%   |
|    INF     | 12250804 | 206  |  5.82%   |
|    SUM     |          | 3539 | 100.00%  |
...
| 日志文件                    | backbone | decode_head            | auxiliary_head | loss | lr_schedule | optim                  | max_epoch |
| :-------------------------- | -------- | ---------------------- | -------------- | ---- | ----------- | ---------------------- | --------- |
| deeplab_resnet_fcn_dws      | resnet50 | deeplabv3plus(dwsASPP) | simple_fcn     | ce   | poly        | SGD(lr=0.01,wd=0.0005) | 200       |
| lr0.004_bz42020-11-14_14:10 |          |                        |                |      |             |                        |           |

#### 最优结果

| metric\classes | backgorund(0) | C(1)     | GL(2) | SAC(3)   | SUP(4) | INF(5) | LHF(6) | HH(7) | SCB(8) | SHB(9) | SAS   |
| -------------- | ------------- | -------- | ----- | -------- | ------ | ------ | ------ | ----- | ------ | ------ | ----- |
| **iou**        | 93.78         | 91.24    | 68.56 | 91.81    | 81.12  | 73.59  | 77.14  | 92.49 | 90.85  | 84.81  | 97.43 |
...
| 日志文件                    | backbone | decode_head    | auxiliary_head | loss | lr_schedule | optim                  | max_epoch |
| --------------------------- | -------- | -------------- | -------------- | ---- | ----------- | ---------------------- | --------- |
| danet_resnet_fcn_dws        | resnet50 | danet(dwsASPP) | simple_fcn     | ce   | poly        | SGD(lr=0.01,wd=0.0005) | 200       |
| lr0.004_bz42020-11-16_17:04 |          |                |                |      |             |                        |           |
