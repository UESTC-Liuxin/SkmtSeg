...
def _resnet(arch, block, layers, BatchNorm,pretrained=True,progress=False, **kwargs):
    model = ResNet(block, layers, BatchNorm=BatchNorm,**kwargs)
    if pretrained:
...
def resnet18(output_stride,BatchNorm,pretrained=True,**kwargs):
    ...
    """
    return _resnet('resnet18', BasicBlock, [2, 2, 2, 2], BatchNorm,pretrained,
                   **kwargs)
...
def resnet34(output_stride,BatchNorm,pretrained=True,**kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34', BasicBlock, [3, 4, 6, 3], BatchNorm,pretrained,
                   **kwargs)
...
def resnet50(output_stride,BatchNorm,pretrained=True,**kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], BatchNorm,pretrained,
                   **kwargs)
...
def resnet101(output_stride,BatchNorm,pretrained=True,**kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet101', Bottleneck, [3, 4, 23, 3],BatchNorm,pretrained,
                   **kwargs)
...
def wide_resnet101_2(output_stride,BatchNorm,pretrained=True,**kwargs):
    ...
    return _resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3],
                   BatchNorm=BatchNorm,pretrained=pretrained, **kwargs)


if __name__ == "__main__":
    x=torch.rand(2,3,512,512)
    model= wide_resnet50_2(output_stride=32,BatchNorm=nn.BatchNorm2d)
    out=model(x)
