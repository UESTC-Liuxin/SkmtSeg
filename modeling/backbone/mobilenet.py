...
class MobileNetV2(nn.Module):
    def __init__(self, output_stride=8, BatchNorm=None, width_mult=1., pretrained=True):
        ...
        self.low_level_features = self.features[0:2]  #4倍下采样
        self.mid_level_features = self.features[2:3]  #8倍下采样
        self.high_level_features = self.features[3:5]  #16倍下采样
        self.origin_level_features=self.features[5:]
    ...
    def forward(self, x):
        ...
        x=self.origin_level_features(high_level_feat)
        return (x,high_level_feat,mid_level_feat,low_level_feat)
